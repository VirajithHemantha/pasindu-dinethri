...
export const RSVPForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://script.google.com/macros/s/AKfycbxjD62E3xI8PDpanue7gJqVWEOFsJ-FkiZTjLu7BR3f17Qqq5S_07BJ5S54RJAhLV82Xg/exec', {
        method: 'POST',
        body: JSON.stringify({
          type: 'rsvp',
          ...formData
        ...
        <div className="lg:w-1/2 lg:pr-10 mb-12 lg:mb-0 relative text-center lg:text-left">
          ...
          <div className="mt-4 mb-6 bg-brand-champagne/50 px-6 py-4 rounded-2xl border border-brand-beige/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-2">
              <div>
                <p className="text-stone-800 font-serif text-lg">Pasindu</p>
                <a href="tel:+94768079771" className="text-brand-beige-deep font-sans text-base font-semibold hover:underline">076 807 9771</a>
              </div>
              <div>
                <p className="text-stone-800 font-serif text-lg">Dinethri</p>
                <a href="tel:+94766720606" className="text-brand-beige-deep font-sans text-base font-semibold hover:underline">076 672 0606</a>
              </div>
            </div>
          </div>
