...
export const Location: React.FC = () => {
  ...
  const liveLocationUrl = "https://maps.app.goo.gl/kz3ev3zUDhr9S4WZ7";
          ...
          <div className="bg-white/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(176,137,104,0.15)] border border-brand-beige/30 lg:translate-x-12 relative overflow-hidden group">
            ...
            <div className="mb-10 relative z-10">
              ...
              <div className="flex items-start gap-5 mt-10">
                ...
                <div>
                  <p className="text-2xl font-serif text-stone-800 mb-1">St. Sebastian's Shrine</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400 leading-relaxed mb-4">Katuneriya</p>

                  <a
                    href="https://maps.app.goo.gl/y9d1g6KcNMNJmfNn7"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 bg-stone-800 text-brand-champagne px-6 py-3 rounded-full font-sans tracking-[0.2em] text-[10px] uppercase hover:bg-stone-900 hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] transition-all duration-300 active:scale-95 group/btn"
                  >
                    <Navigation className="w-3 h-3 text-brand-gold group-hover/btn:rotate-45 transition-transform duration-300" />
                    Church Location
                  </a>
                </div>
              </div>

              <div className="flex items-start gap-5 mt-8 border-t border-brand-beige/20 pt-8">
                <div className="w-12 h-12 bg-stone-50 rounded-full border border-brand-beige/40 shadow-inner flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  <MapPin className="text-brand-beige-deep w-5 h-5" />
                </div>
                <div>
                  <p className="text-2xl font-serif text-stone-800 mb-1">Senuri Grand Castello</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400 leading-relaxed mb-4">Divulapitiya</p>
