        ...
        <div className="lg:w-1/2 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-stone-500/90 font-serif text-lg sm:text-xl leading-relaxed mb-16 max-w-lg">
              We are honored to invite you to witness our union as we exchange vows at St. Sebastian's Shrine, surrounded by the grace of God and the warmth of our loved ones.
            </p>
            ...
            <div className="relative space-y-12 ml-10 sm:ml-12 border-l-[1.5px] border-brand-beige/30 pl-10 sm:pl-12 py-4">
              ...
              <div className="relative group">
                ...
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">Thursday, July 16</h4>
              ...
              <div className="relative group">
                ...
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">08:00 AM</h4>
                  <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.3em] font-bold">Wedding Ceremony — <a href="https://maps.app.goo.gl/y9d1g6KcNMNJmfNn7" target="_blank" rel="noopener noreferrer" className="hover:text-brand-beige-deep underline underline-offset-2">St. Sebastian's Shrine, Katuneriya</a></p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div>
                  <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-2 group-hover:text-brand-beige-deep transition-colors duration-500">11:27 AM</h4>
                  <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.3em] font-bold">Poruwa Ceremony — Senuri Grand Castello</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
              ...
              <div className="flex-1">
                <h4 className="font-display text-2xl sm:text-4xl text-stone-800 mb-1 sm:mb-2 tracking-tight">Poruwa & Reception</h4>
                <p className="text-stone-500/90 font-serif text-sm sm:text-base leading-relaxed">
                  Followed by the Traditional Poruwa Ceremony and thereafter a Reception at Senuri Grand Castello.
                </p>
              </div>
              <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-brand-champagne rounded-full border border-brand-beige/30 shadow-sm self-start sm:self-center flex-shrink-0">
                <span className="text-brand-beige-deep font-sans font-bold tracking-[0.1em] sm:tracking-[0.2em] text-[9px] sm:text-[11px] uppercase block drop-shadow-sm">11:27 AM Onwards</span>
              </div>
            </div>
          </motion.div>
        </div>
