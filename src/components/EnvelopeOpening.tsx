...
export function EnvelopeOpening({ onComplete, onMusicStart, guestPrefix, guestName }: EnvelopeProps) {
            ...
            <div className="card-border">
              ...
              {guestName && (
                <div className="mb-4 text-center">
                  <p className="font-serif italic text-sm text-stone-600 mb-1 leading-relaxed px-4">
                    We cordially invite
                  </p>
                  <p className="font-sans font-medium text-[13px] uppercase tracking-[0.2em] text-brand-beige-deep">
              ...
              <div className="text-details">
                ...
                <span className="text-date">Thursday 16 July 2026 At 8:00 AM</span>
                <span className="text-church">St. Sebastian's Shrine</span><br />
                Katuneriya
              </div>
            </div>
          </div>
