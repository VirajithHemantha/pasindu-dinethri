      ...
      <div className="text-center mb-16 sm:mb-24 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl sm:text-7xl font-display text-stone-800 tracking-tight drop-shadow-sm">
            Dinethri <span className="italic text-brand-beige-deep font-light mx-2">&</span> Pasindu
          </h2>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Son of Mr. Primal Awantha Fernando<br />& Mrs. Elsie Norico Almeida</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <h3 className="text-4xl sm:text-5xl font-display text-stone-800 mb-2 drop-shadow-sm">Dinethri</h3>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Daughter of Mr. Senarath Gunawardhana<br />& Mrs. Niroshi Waidyathilaka</p>
          </div>
